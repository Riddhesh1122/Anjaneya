...
const navItems = [
  { key: "home", label: "Dashboard", icon: LayoutDashboard, highlight: false, roles: null },
  { key: "events", label: "Events", icon: Calendar, highlight: false, roles: null },
  { key: "my-tickets", label: "My Tickets", icon: Ticket, highlight: false, roles: null },
  // Staff-only workspace sections — hidden for plain attendees.
  { key: "volunteers", label: "Volunteers", icon: UserCheck, highlight: false, roles: ["organizer", "admin", "volunteer"] },
  { key: "tasks", label: "Tasks", icon: CheckSquare, highlight: false, roles: ["organizer", "admin", "volunteer"] },
  { key: "attendance", label: "Attendance", icon: ClipboardCheck, highlight: false, roles: ["organizer", "admin", "volunteer"] },
  { key: "analytics", label: "Analytics & Insights", icon: BarChart3, highlight: false, roles: ["organizer", "admin"] },
  { key: "ai-studio", label: "AI Studio", icon: Sparkles, highlight: true, roles: null },
  { key: "users", label: "Community", icon: Users, highlight: false, roles: null },
  { key: "settings", label: "Settings", icon: Settings, highlight: false, roles: null },
] as const;
...
interface SidebarProps {
  ...
  /** Current user's role. When omitted (demo/no-role session) every section is shown. */
